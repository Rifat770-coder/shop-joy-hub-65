        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 p-6 md:p-10 lg:p-14">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="max-w-xl">
              ...
              <Link to="/deals">
                <Button size="lg" className="bg-white text-purple-700 hover:bg-white/90 font-semibold shadow-lg shadow-purple-900/30 gap-2 transition-all hover:scale-105">
                  Shop Now
            ...
            <div className="flex gap-3 md:gap-4">
              ...
              value: '52',
              label: 'Sec'
            }].map((item, index) => <div key={item.label} className="text-center">
